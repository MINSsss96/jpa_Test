...
class UsersRepositoryTest {
    ...
    void findByNameTest() {
        String name = "Eugenius Gouldbourn";
        usersRepository
                .findByName(name)
                .stream()
    ...
    @Test
    @DisplayName("성별이 여자이고 좋아하는 색상이 Red 인 자료 찾기 테스트")
    ...
    @Test
    @DisplayName("findByCreatedAtAfter 테스트")
...
//        List<String> colors = new ArrayList<>(Lists.newArrayList("Red","Pink"));
        usersRepository.findByLikeColorIn(Lists.newArrayList("Red","Pink"))
                .forEach(x-> System.out.println(x));
    }

    @Test
    @DisplayName("아이디가 91이상인 자료 찾기")
    ...
    @Test
    @DisplayName("findTop10ByLikeColorOrderByGenderAscByCreatedAtDesc")
